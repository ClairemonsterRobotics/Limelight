...
import org.usfirst.frc5474.Orion.commands.ourArcadeDrive;
...
public class driveSub extends Subsystem {
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new ourArcadeDrive());
    ...
    public void subArcadeDrive(Joystick stick, Boolean straight) {
        if (!straight) {
            diffDrive.arcadeDrive(-stick.getY() * 0.8, stick.getRawAxis(4) * 0.7, true);
        } else {
